...
let tag = `@${m.sender.split('@')[0]}`
 ...
 m, { contextInfo: { mentionedJid: conn.parseMention(tag) }}
    ...
    let tks = `Saya adalah _*BOTCAHX*_ salah satu Bot Whatsapp yang diciptakan oleh : ${ow}
Silahkan tekan Tombol ${user.registered ? '"Menu"' : '"Menu"'} untuk ${user.registered ? 'melihat list command dari' : 'list menu bot'} _*BOTCAHX*_.
