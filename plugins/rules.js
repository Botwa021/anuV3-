...
5. MursidBot bertanggung jawab atas kesalahan fatal dalam penggunaan bot
...
Rules: 23 Mei 2022	
  ...
  const button = {
        ...
        description: kontol,
        sections:  [{title: "Silahkan di pilih yaa kam", rows: [
        ...
        {title: 'Nomor Owner', description: "CHAT BAGI YANG KEPENTINGAN/DI LARANG MEMINTA SV", rowId:".owner"},
       ] }],
        listType: 1
       }
